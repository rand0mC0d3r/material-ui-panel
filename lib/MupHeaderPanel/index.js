...
var useStyles = (0, _styles.makeStyles)(function (theme) {
  return {
    collapseButton: {
      ...
      lineHeight: '0px' // border: '1px solid red'

    },
    defaultFunctions: {
      border: "1px dotted ".concat(theme.palette.divider),
      borderRadius: '4px',
      display: 'flex',
...
var MupHeaderPanel = (0, _styles.withTheme)(function (_ref) {
  var _ref$layoutObject = _ref.layoutObject,
      ...
      extraButtons = _ref$layoutObject.extraButtons,
  ...
  var wrapOrNotInTooltip = function wrapOrNotInTooltip(tooltip) {
    var extras = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var node = arguments.length > 2 ? arguments[2] : undefined;
    return tooltipComponent && tooltip ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, tooltipComponent(tooltip, /*#__PURE__*/(0, _react.cloneElement)(node, extras))) : /*#__PURE__*/(0, _react.cloneElement)(node, extras);
  };
  ...
  return /*#__PURE__*/_react.default.createElement(_core.Box, {
  ...
  }, extraButtons && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, extraButtons.map(function (extraButton) {
    return /*#__PURE__*/_react.default.createElement("div", _defineProperty({
      key: extraButton.key,
      onClick: function onClick() {
        return extraButton.onClick && extraButton.onClick();
      }
    }, "key", extraButton.key), extraButton.node && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, wrapOrNotInTooltip(extraButton.tooltip, {}, extraButton.node)), extraButton.icon && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_core.Button, {
      className: classes.collapseButton,
      size: "small"
    ...
    className: classes.defaultFunctions
