...
var MupButton = function MupButton(_ref) {
  ...
  var registerPanel = (0, _react.useCallback)(function (id) {
  ...
  }, [isRegistered, id, icon, registerPanel]); //todo add de-register button
...
MupButton.propTypes = {
  ...
  onClick: _propTypes.default.oneOf([_propTypes.default.func, _propTypes.default.undefined])
};
