...
var MupSectionsSplitter = function MupSectionsSplitter(_ref) {
  ...
  var generateButton = function generateButton(_ref2) {
    var className = _ref2.className,
        action = _ref2.action;
    return /*#__PURE__*/React.createElement(_core.Button, {
      className: "".concat(classes.block, " ").concat(className),
      onClick: action,
      onTouchStart: action
    });
  };
  ...
  var blocks = [{
    ...
    content: /*#__PURE__*/React.createElement("div", {
      ...
      className: classes.blockHorizontal,
    ...
    content: /*#__PURE__*/React.createElement("div", {
      ...
      className: classes.blockVertical,
      action: function action() {
        return createSection({
          type: 'hs',
          index: 0,
  ...
  return visible ? /*#__PURE__*/React.createElement("div", {
  ...
  })) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_core.Tooltip, {
    ...
    onClick: toggleVisible
  }, /*#__PURE__*/React.createElement(_VerticalSplit.default, null))));
};
