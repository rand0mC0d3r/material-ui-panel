...
var MuiPanelManager = function MuiPanelManager(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_core.Box, {
    ...
    }).length > 0 && /*#__PURE__*/React.createElement(_core.Tooltip, {
      title: settings.isCollapsed ? 'DoubleClick to expand' : '',
      arrow: true,
      placement: "left"
    }, /*#__PURE__*/React.createElement("div", {
      id: "".concat(side, "-menu"),
  ...
  })), children), status.length > 0 && /*#__PURE__*/React.createElement(_core.Box, {
    id: "MuiStatusBarList",
    onContextMenu: function onContextMenu(e) {
      e.preventDefault();
    },
