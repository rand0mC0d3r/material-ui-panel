...
var _excluded = ["allowRightClick", "initialSide", "markerColor", "inverseMarkers", "debugMode", "showCollapseButton", "showSplitterButton"];
...
function MuiPanelProvider(_ref) {
  ...
  var handleContentAnnouncement = function handleContentAnnouncement(_ref5) {
    var id = _ref5.id,
  ...
  var handleSetAsGroup = function handleSetAsGroup(_ref6) {
  ...
  var handleSetStatusElements = function handleSetStatusElements(_ref7) {
  ...
  var handleUnSetAsEmbedded = function handleUnSetAsEmbedded(_ref8) {
  ...
  var setSectionUrl = function setSectionUrl(_ref9) {
  ...
  var toggleSectionDirection = function toggleSectionDirection(_ref10) {
  ...
  var toggleCollapseSection = function toggleCollapseSection(_ref11) {
  ...
  var addZoneToSection = function addZoneToSection(_ref12) {
  ...
  var removeZoneFromSection = function removeZoneFromSection(_ref13) {
  ...
  var addPanelToSection = function addPanelToSection(_ref14) {
    var sectionId = _ref14.sectionId,
        panelId = _ref14.panelId;
  ...
  var removePanelFromSection = function removePanelFromSection(_ref15) {
    var sectionId = _ref15.sectionId,
        panelId = _ref15.panelId;
  ...
  var showContent = function showContent(_ref16) {
  ...
  var splitContentNg = function splitContentNg(_ref17) {
  ...
  var splitContent = function splitContent(_ref18) {
  ...
  var chooseTypeForSection = function chooseTypeForSection(_ref19) {
    var panelId = _ref19.panelId,
        _ref19$type = _ref19.type,
        type = _ref19$type === void 0 ? 'list' : _ref19$type;
    var foundPanelId = null;
    setSections(function (sections) {
      return sections.map(function (section) {
  ...
  var handlePanelAlerts = function handlePanelAlerts(_ref20) {
    var id = _ref20.id,
        count = _ref20.count,
        color = _ref20.color;
  ...
  var handleToggleCollapse = function handleToggleCollapse(_ref21) {
  ...
  var handleSetAsEmbedded = function handleSetAsEmbedded(_ref22) {
    var uniqueId = _ref22.uniqueId,
        parentId = _ref22.parentId;
  ...
  var handleSetSide = function handleSetSide(_ref23) {
    var uniqueId = _ref23.uniqueId;
    setLayout(layout.map(function (layoutObject) {
  ...
  var handleSetVisible = function handleSetVisible(_ref24) {
